...
namespace XGENO.Framework.Behaviors
{
    ...
    public class KeyBehavior : DependencyObject, IBehavior
    {
        ...
        public static readonly DependencyProperty ActionsProperty = DependencyProperty.Register(nameof(Actions), typeof(ActionCollection), typeof(KeyBehavior), new PropertyMetadata(null));
