...
namespace XGENO.Framework.Utils
{
    public class DeviceUtils
    {
        ...
        public static DeviceFamilies CurrentDeviceFamily
        {
            get
            {
                ...
                switch (family)
                {
                    ...
                    case "Windows.Team": 
                        return DeviceFamilies.Team;
                    case "Windows.IoT": 
                        return DeviceFamilies.IoT;
                    case "Windows.Xbox": 
                        return DeviceFamilies.Xbox;
                    case "Windows.Holographic": 
                        return DeviceFamilies.HoloLens;
                    default: 
                        return DeviceFamilies.Unknown;
                }
            }
        }
        ...
        public DeviceDispositions DeviceDisposition()
        {
            ...
            switch (DeviceFamily())
            {
                case DeviceFamilies.Desktop: 
                    return DeviceDispositions.Desktop;
                case DeviceFamilies.Team: 
                    return DeviceDispositions.Team;
                case DeviceFamilies.IoT: 
                    return DeviceDispositions.IoT;
                case DeviceFamilies.Xbox: 
                    return DeviceDispositions.Xbox;
                case DeviceFamilies.HoloLens: 
                    return DeviceDispositions.HoloLens;
                ...
                default: 
                    return DeviceDispositions.Unknown;
            }
        }
